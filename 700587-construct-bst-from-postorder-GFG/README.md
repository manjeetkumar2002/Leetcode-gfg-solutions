# [Construct BST from Postorder](https://www.geeksforgeeks.org/problems/construct-bst-from-post-order/1?page=1&difficulty%5B%5D=0&category%5B%5D=Binary%2520Search%2520Tree&sortBy=submissions)
## Easy
